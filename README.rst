...
The current release of xhtml2pdf is **xhtml2pdf 0.2.10**. Release Notes can be found here: `Release Notes <https://xhtml2pdf.readthedocs.io/en/latest/release-notes.html>`__
