...
class myLinkLoader:
    ...
    def getFileName(self, path: str, relative: str | None = None) -> str | None:
        # ruff: noqa: PLC0415
        import tempfile
