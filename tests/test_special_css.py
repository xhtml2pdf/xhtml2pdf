...
class FontTest(TestCase):
    ...
    def test_font_style_size_family(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('font-style', 'italic', None),
    ...
    def test_font_variant_size_family(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('font-variant', 'small-caps', None),
                    ('font-size', ('15', 'px'), None),
                    ('font-face', ['Comic Sans'], None)]
        self.assertEqual(func_out, expected)
    ...
    def test_font_weight_size_family(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('font-weight', 'bold', None),
                    ('font-size', ('15', 'px'), None),
                    ('font-face', ['Comic Sans'], None)]
        self.assertEqual(func_out, expected)

    def test_font_style_variant_weight_size_height_family(self):
        func_in = [('font', ['italic', 'small-caps', 'bold', (('15', 'px'), '/', ('30', 'px')), 'Comic Sans'], None)]
        func_out = parseSpecialRules(func_in)
        expected = [('font-style', 'italic', None),
...
class MarginTest(TestCase):
    ...
    def test_one_margin_value(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('margin-left', ('11', 'px'), None),
    ...
    def test_two_margin_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('margin-left', ('22', 'px'), None),
    ...
    def test_four_margin_values(self):
        func_in = [('margin', [('11', 'px'), ('22', 'px'), ('33', 'px'), ('44', 'px')], None)]
        func_out = parseSpecialRules(func_in)
        expected = [('margin-left', ('44', 'px'), None),
                    ('margin-right', ('22', 'px'), None),
                    ('margin-top', ('11', 'px'), None),
                    ('margin-bottom', ('33', 'px'), None)]
        self.assertEqual(func_out, expected)
...
class PaddingTest(TestCase):
    ...
    def test_one_padding_value(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('padding-left', ('11', 'px'), None),
    ...
    def test_two_padding_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('padding-left', ('22', 'px'), None),
    ...
    def test_four_padding_values(self):
        func_in = [('padding', [('11', 'px'), ('22', 'px'), ('33', 'px'), ('44', 'px')], None)]
        func_out = parseSpecialRules(func_in)
        expected = [('padding-left', ('44', 'px'), None),
                    ('padding-right', ('22', 'px'), None),
                    ('padding-top', ('11', 'px'), None),
                    ('padding-bottom', ('33', 'px'), None)]
        self.assertEqual(func_out, expected)
...
class BorderWidthTest(TestCase):
    ...
    def test_one_border_width_value(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-width', ('11', 'px'), None),
    ...
    def test_two_border_width_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-width', ('22', 'px'), None),
    ...
    def test_four_border_width_values(self):
        func_in = [('border-width', [('11', 'px'), ('22', 'px'), ('33', 'px'), ('44', 'px')], None)]
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-width', ('44', 'px'), None),
                    ('border-right-width', ('22', 'px'), None),
                    ('border-top-width', ('11', 'px'), None),
                    ('border-bottom-width', ('33', 'px'), None)]
        self.assertEqual(func_out, expected)
...
class BorderColorTest(TestCase):
    def test_one_border_color_value(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-color', 'red', None),
    ...
    def test_two_border_color_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-color', 'green', None),
    ...
    def test_four_border_color_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-color', 'pink', None),
                    ('border-right-color', 'green', None),
                    ('border-top-color', 'red', None),
                    ('border-bottom-color', 'blue', None)]
        self.assertEqual(func_out, expected)
...
class BorderStyleTest(TestCase):
    ...
    def test_one_border_style_value(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-style', 'dotted', None),
    ...
    def test_two_border_style_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-style', 'solid', None),
    ...
    def test_four_border_style_values(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-style', 'dashed', None),
                    ('border-right-style', 'solid', None),
                    ('border-top-style', 'dotted', None),
                    ('border-bottom-style', 'double', None)]
        self.assertEqual(func_out, expected)
...
class BorderTest(TestCase):
    ...
    def test_border_width_style(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-left-width', ('99', 'px'), None),
...
class BorderTop(TestCase):
    ...
    def test_border_top_widt_style(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-top-width', ('99', 'px'), None),
                    ('border-top-style', 'dotted', None)]
        self.assertEqual(func_out, expected)
...
class BorderBottom(TestCase):
    ...
    def test_border_top_width_style_color(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-bottom-width', ('99', 'px'), None),
                    ('border-bottom-style', 'dotted', None),
                    ('border-bottom-color', 'red', None)]
        self.assertEqual(func_out, expected)
...
class BorderRight(TestCase):
    ...
    def test_border_top_width_style_color(self):
        ...
        func_out = parseSpecialRules(func_in)
        expected = [('border-right-width', ('99', 'px'), None),
                    ('border-right-style', 'dotted', None),
                    ('border-right-color', 'red', None)]
        self.assertEqual(func_out, expected)
