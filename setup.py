...
setup(
    ...
    install_requires=["arabic-reshaper>=3.0.0", "html5lib>=1.0.1", "Pillow>=8.1.1",
                      "pyHanko>=0.12.1", "pyhanko-certvalidator>=0.19.5",
                      "pypdf>=3.1.0", "python-bidi>=0.4.2", "reportlab>=3.5.53",
                      "svglib>=1.2.1"],
